...
import { ITiktokPostsFilters, ITiktokUsersFilters, SortBy } from '../../../types/tiktok'
...
interface IProps {
    filters: Partial<ITiktokUsersFilters> & Partial<ITiktokPostsFilters>
...
export const TiktokFilters: React.FC<IProps> = React.memo((props) => {
    const {
        ...
        onChangeSubcultures, onChangeTags, applyFilters, clearFilters, onDownloadExcel, onChangeDateAt,
        onChangeCommentsCountMax, onChangeCommentsCountMin, onChangeReactionsCountMax, onChangeReactionsCountMin,
        onChangeDateTo
    } = props
                                    ...
                                    <div className="main-filters__cols main-filters__cols_telegram">
                                        {onChangeSubscribersCountMax && onChangeSubscribersCountMin && typeof filters.subscribersCountMax === "number" &&
                                            ...
                                            <div className="main-filters__col main-filters__col_tablet-last">
                                                ...
                                                <FilterRange onUpdateEndValue={onChangeSubscribersCountMax} onUpdateStartValue={onChangeSubscribersCountMin} min={0} max={10000000} startValue={filters.subscribersCountMin} endValue={filters.subscribersCountMax} text="Количество подписчиков" />
                                            </div>}
                                        {onChangePostsCountMax && onChangePostsCountMin && typeof filters.postsCountMax === "number" &&
                                            typeof filters.postsCountMin === "number" &&
                                            <div className="main-filters__col main-filters__col_tablet-last">

                                                <FilterRange onUpdateEndValue={onChangePostsCountMax} onUpdateStartValue={onChangePostsCountMin} min={0} max={10000000} startValue={filters.postsCountMin} endValue={filters.postsCountMax} text="Количество публикаций" />
                                            </div>}
